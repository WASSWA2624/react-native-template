/**
 * SystemBanner Component - Android
 * Global system banner for offline/online/maintenance notices
 * File: SystemBanner.android.jsx
 */
...
import {
  ...
  StyledMessage,
  StyledTitle,
} from './SystemBanner.android.styles';
...
/**
 * SystemBanner component for Android
 * @param {Object} props - SystemBanner props
 */
const SystemBannerAndroid = ({
...
export default SystemBannerAndroid;
